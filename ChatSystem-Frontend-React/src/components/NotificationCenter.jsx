...
export default function NotificationCenter() {
    ...
    if (!recentNotifications || recentNotifications.length === 0) {
        return (
            <div className="border-t border-gray-100 px-5 py-4">
                <h3 className="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2">通知中心</h3>
                <p className="text-xs text-gray-300 text-center py-3">暂无新通知</p>
            </div>
        );
    }
    ...
    return (
        <div className="border-t border-gray-100 px-3 py-3 overflow-y-auto" style={{ maxHeight: '34%' }}>
            <h3 className="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2 px-2">通知中心</h3>
            <div className="space-y-1">
                {recentNotifications.slice(0, 10).map((notification) => (
                    ...
                    >
                        <div className="w-2 h-2 mt-1.5 bg-gradient-to-r from-blue-400 to-cyan-400 rounded-full shrink-0" />
