...
export default function SessionInfoModal({ session, onClose }) {
    ...
    // 判断是否是群聊（没有 single_chat_friend_id 就是群聊）
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4 overflow-hidden max-h-[80vh] flex flex-col">
                ...
                <div className="h-16 px-5 flex items-center justify-between border-b border-gray-100 shrink-0">
                    <h2 className="font-semibold text-gray-900">会话信息</h2>
                    <button
                        onClick={onClose}
                ...
                <div className="flex-1 overflow-y-auto p-5">
                    ...
                    <div className="text-center mb-6">
                        <div className="w-16 h-16 mx-auto mb-3 rounded-xl bg-gradient-to-br from-[#0B4F6C] to-[#0a4560] flex items-center justify-center text-white text-2xl font-bold">
                            {isGroupChat ? (
                                            ...
                                            <div className="flex-1">
                                                <p className="font-medium text-gray-900">
                                                    ...
                                                    {member.user_id === user?.user_id && (
                                                        <span className="ml-2 text-xs text-[#0B4F6C] bg-[#E0F2F7] px-2 py-0.5 rounded">
                                                            我
                                                        </span>
                                                    )}
                                                </p>
                    ...
                    {!isGroupChat && (
                        <div className="bg-gray-50 rounded-xl p-4">
                            <p className="text-sm text-gray-500">
                                这是与 <span className="font-medium text-gray-700">{session.chat_session_name}</span> 的私聊会话
                            </p>
                        </div>
                    )}
                </div>
