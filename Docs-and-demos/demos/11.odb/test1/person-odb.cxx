...
namespace odb
{
        ...
        my_bool* t)
  {
    ...
    if (t[2UL])
    {
      i._length_value.capacity (i._length_size);
      grew = true;
    }
        ...
        mysql::statement_kind sk)
  {
    ...
    b[n].buffer = i._length_value.data ();
    b[n].buffer_length = static_cast<unsigned long> (
      i._length_value.capacity ());
    b[n].length = &i._length_size;
        ...
        mysql::statement_kind sk)
  {
    ...
    //
    {
      ...
      bool is_null (false);
      std::size_t size (0);
      std::size_t cap (i._length_value.capacity ());
      mysql::value_traits<
          double,
      ...
      i._length_size = static_cast<unsigned long> (size);
      grew = grew || (cap != i._length_value.capacity ());
    }
